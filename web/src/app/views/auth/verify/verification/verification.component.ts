...
export class VerificationComponent implements OnInit {
  ...
  constructor(private router: Router, private activateRoute: ActivatedRoute, private formBuilder: FormBuilder, private commonService: CommonService, private toastr: ToastrService) { }
  ...
  resendOtp() {
    this.commonService.resendOtp(this.verifyForm.value.type).subscribe(data => {
      if (data.status) {
        this.toastr.success(data.message, "SUCCESS")
      }
    })
