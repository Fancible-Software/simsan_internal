import { Authorized, Body, Controller, Get, Params, Post, Res, CurrentUser, UploadedFile } from "routing-controllers";
import logger from "../utils/logger";
import { UserPermissions, ResponseStatus, SkipLimitURLParams, ConfigurationParams, EntityId } from "../types";
...
export class ConfigurationController {
    ...
    async createSettings(
        ...
        try {
            ...
            const newConfigRecord: Configurations = body.toConfiguration(user.id.toString())
    ...
    async getDetail(
        ...
        try {
            const configRepository: Repository<Configurations> = getConnection().getRepository(Configurations);
            const configObj: Configurations | undefined = await configRepository.findOne(id);
